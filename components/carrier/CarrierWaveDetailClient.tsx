...
export default function CarrierWaveDetailClient({ waveId }: { waveId: string }) {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Accettazione wave card */}
      {wave && (wave.status || "").toLowerCase() === "inviata" && (
        <div className="rounded-2xl border bg-white p-4 shadow-sm">
          <div className="space-y-3">
            <div className="text-sm font-semibold text-slate-900">Accetta wave</div>
            <div className="text-xs text-slate-600">
              Ricopia il testo qui sotto per confermare l'accettazione della wave
            </div>
            <div className="flex gap-2">
              <input
                ...
                placeholder="accetto ritiro e trasporto"
